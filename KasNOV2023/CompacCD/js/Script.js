...
(function ($) {
    "use strict";
    $(".CompacCD").append('<div class="player-wpr"><div class="player is-playing"><div class="blur"></div><div class="player-ctr"><div class="listeners fal fa-users"></div><div class="album-cover-wpr"><div class="social-share-wpr animated"><a href="" target="_blank" class="social-link social-link-facebook fab fa-facebook.f animated" id="aface"></a> <a href="" target="_blank" class="social-link social-link-twitter fab fa-twitter animated" id="atwitter"></a></div><div class="tapa"></div><div class="album-cover animated"></div><div class="album-cover2 animated"></div><div class="vinyl"></div></div><div class="track-info-wpr"><div class="track-info-ctr"><div class="marquee"> <span class="artist-name animated">Artist</span><span> - </span><span class="songtitle animated">Songtitle</span></div></div></div><div class="ppBtn play-btn fal"></div><div class="servertitle"></div></div><div class="icons-left-wpr"><div class="icons-left icons-history fal fa-history"></div></div><div class="icons-right-wpr"><div class="icons-right icons-volume fal fa-volume.up"></div><div class="icons-right icons-volumeM fal fa-volume"></div></div> <input class="volume-slider" type="range" min="0" max="100" step="0.10" value="" autocomplete="off"><div class="history-wpr nodisplay"><div class="history-title">Ultimas Reproducciones</div></div></div>');
    $.fn.CompacCD = function (options) {
        var settings = $.extend({
            URL: "",
            version: "2",
            stream_id: 1,
